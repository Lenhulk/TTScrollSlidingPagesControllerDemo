...
#import "UIColor+NTExtension.h"

@implementation UIColor (NTExtension)
...
+ (NSMutableArray<NSNumber *> *) changeUIColorToRGB:(UIColor *)color
{
    ...
    [RGBStrValueArr addObject:@(roundf(r))];
    //获取绿色值
    float g = [[RGBArr objectAtIndex:2] floatValue] * 255;
    [RGBStrValueArr addObject:@(roundf(g))];
    //获取蓝色值
    float b = [[RGBArr objectAtIndex:3] floatValue] * 255;
    [RGBStrValueArr addObject:@(roundf(b))];
    //返回保存RGB值的数组
